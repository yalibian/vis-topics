...
function drawViz() {
	...
	var width = $("#flow_viz").width();//d3.select("#flow_viz").attr("width");
...
function resetFilters() {
	...
	$("#keyword_weight_slider").slider("values", [$("#keyword_weight_slider").slider("option","min"),
											  		 $("#keyword_weight_slider").slider("option","max")]);
	$("#period_section_slider").slider("values", [$("#period_section_slider").slider("option","min"),
											  		 $("#period_section_slider").slider("option","max")]);
